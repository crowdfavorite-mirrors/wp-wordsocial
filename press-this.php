...
?>
	<link rel="stylesheet" href="<?php bloginfo('wpurl'); ?>/wp-content/plugins/wordsocial/medias/admin-posts.css" />
...
?>
	...
	jQuery(document).ready(function($) {
		...
		$('#tagsdiv-post_tag, #categorydiv, #wsodiv').children('h3, .handlediv').click(function(){
...
<div id="poststuff" class="metabox-holder">
	<div id="side-info-column">
		<div class="sleeve">
			...
			<!-- WordSocial -->
			<?php if(function_exists('wso_inner_meta_boxes')) : ?>
			<div id="wsodiv" class="postbox">
				<div class="handlediv" title="<?php _e( 'Click to toggle' ); ?>"><br /></div>
				<h3><span>WordSocial</span></h3>
				<div class="inside">
					<?php wso_inner_meta_boxes(); ?>
				</div>
			</div>
			<?php endif; ?>
			<!-- /WordSocial -->
